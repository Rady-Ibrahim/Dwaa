...
class ClientFileCompareController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        $data = $request->validate([
            ...
            'col_name_a' => ['nullable', 'string'],
            'col_price_a' => ['nullable', 'string'],
            'col_discount_a' => ['nullable', 'string'],
            'col_name_b' => ['nullable', 'string'],
            'col_price_b' => ['nullable', 'string'],
        ...
        try {
            $result = $this->fileCompareService->compareUploadedFiles(
                ...
                $pathB,
                [
                    'name' => $data['col_name_a'] ?? null,
                    'price' => $data['col_price_a'] ?? null,
                    'discount' => $data['col_discount_a'] ?? null,
                ],
                [
                    'name' => $data['col_name_b'] ?? null,
