...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            <div class="bg-[#121212]/90 backdrop-blur-xl border border-[#ef233c]/40 rounded-2xl p-6 lg:w-64 flex flex-col items-center justify-center text-center lg:sticky lg:top-6 lg:self-start lg:h-fit shrink-0">
            ...
            <div class="custom-table-card overflow-x-auto flex-1">
    ...
    <script>
        ...
        async function loadSuppliersToday() {
            suppliersTodayBody.innerHTML =
                '<tr><td colspan="4" class="p-6 text-center text-slate-400">جاري التحميل...</td></tr>';
            ...
            try {
                ...
                console.error(err);
                suppliersTodayBody.innerHTML =
                    '<tr><td colspan="4" class="p-6 text-center text-rose-400">فشل تحميل البيانات.</td></tr>';
        ...
        function renderSuppliersToday(data) {
            ...
            if (!rows.length) {
                suppliersTodayBody.innerHTML =
                    '<tr><td colspan="4" class="p-6 text-center text-slate-500">لا يوجد موردون حدّثوا عروضهم اليوم.</td></tr>';
                return;
            }
